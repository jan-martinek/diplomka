...
V této kapitole budou představena východiska jednání aktérů, tedy určité obecné hodnotové struktury, na jejichž základě jsou utvářeny postoje aktérů vůči konkrétním součástem praxe. Název kapitoly "Pro a proti" odkazuje k bipolárnímu sporu --- tak tomu mnohdy nebylo. Jednak existuje velké množství rovin pojednávání institucionálního mechanismu, zároveň ne v každé z nich existovaly pouhé dva póly diskuse. Rámování postoji *pro* a *proti* je důležité především kvůli tomu, že na mnohých zde vykreslených východiscích vznikaly "konfliktní linie" sporů a tím byla vyjasňována podoba instituce.

# Metodika

Autor přicházel s osobním porozuměním situaci, které následně vystavil reflexi opakovaným čtením interní komunikace mezi aktéry a kódováním jednotlivých textů do kategorií. Dále pořídil šest rozhovorů s aktéry blízkými komisi (dvěma členy vedení a čtyřmi členy komise), z nichž byly vybrány klíčové citace a ty byly kódovány obdobným způsobem jako psané texty.^[vzorekx] 

[^vzorekx]:Celkový rozsah textové báze byl 323 827 znaků v 86 relevantních psaných textech interní komunikace (z celkových 517), 37 794 znaků v textech převzatých ze studentského časopisu Halas a 86 663 znaků v přepisech rozhovorů (celkem se zatím v komisi vystřídalo 11 komisařů). Omezením vzorku je jednak relativně malý počet aktérů, dále soustředění na aktéry přímo spojené s komisí a vynechání členů Studentské komory AS a žadatelů o stipendia. V předem daném časovém omezení se však tento vzorek zdál být nejlépe reprezentativním --- pokrývá aktéry se zkušeností nejvíce odlišnou od zkušenosti autora, zároveň je díky dostatečnému množství možné sledovat, že jsou témata "vyčerpávána" a opakují se. Zdá se nicméně, že další rozšíření by i tak bylo stále hodnotné.

Na tomto základě autor vymezil několik klíčových témat a názorových rozdílů, které pak dalším opakovaným čtením upravoval, doplňoval a ilustroval citacemi. Původně zamýšlené pochopení výchozí situace a motivů jednotlivých aktérů je kvůli časovému odstupu včleněno do širšího kontextu vnímání činnosti komise v prvním roce a půl její činnosti, nicméně zkrystalizovaná témata vypovídají (jednak díky možnosti využít průběžně vznikající interní komunikace a jednak kvůli stabilitě názorů zapojených aktérů) o celém období. Sám autor může přiznat, že jeho subjektivní vnímání významnosti některých témat (například efektivity fungování komise nebo její konvenčnosti) se v konfrontaci s touto širší textovou bází ukázalo být spíše menšinové. Celá kapitola je postavena na mnoha citacích, s nimiž je pracováno jako s reprezentací širšího jevu.

Během rozhovoru autor pokládal široce formulované dotazy s pobídnutím k co nejširší odpovědi, které upřesňoval pouze v případě, pokud osoba poskytující rozhovor určité téma pominula. U různých aktérů byly podle jejich situace některá témata potlačena, obecně se rozhovor týkal následujících témat:^[Autor si je vědom omezení daných rozhovorů, ve většině oblastí by bylo hodnotné provést sekundární dotazování, které však ji nebylo možné uskutečnit z časových důvodů.]
...
Užívané citace ze všech zdrojů jsou jazykově upraveny, v některých případech přeloženy do češtiny, pozice citovaných jsou označovány pouze velmi obecně vymezenou pozicí (člen vedení, člen komise atp.), jména užívaná v citacích jsou nahrazena dostatečně přesnou pozicí aktéra uvnitř fakulty (kde je možné obecnější označení bez ztráty důležitého významu, je ho využito) a je sjednocen užívaný gramatický rod.^[Autor si je vědom komplikací, které z tohoto sjednocení vycházejí, nicméně v daných okolnostech jde o nejsnadnější řešení problému.] Všechny takové citace jsou pro odlišení uvedeny kurzívou. Drobné úpravy (především skloňování) jsou v citacích vyznačovány hranatými závorkami pozměněných pasáží; nejsou vypouštěna slova či měněny užívané termíny. Sebe-citace, tedy vyjádření autora tohoto textu, jsou vždy explicitně označeny.

# Témata, rozdílná názorová východiska a spory
...
-   **podoba deliberativní praxe:** prostředek hodnocení projektů (důraz na efektivitu); prostředek rozvoje prostředí (důraz na dlouhodobé působení)
...
### Úprava stávajícího stavu / Předání pravomoci studentům

Téma vzniku komise bylo spíše završením diskusí vedených po dlouhou dobu mezi různými zástupci vedení fakulty a studentů. V konečné fázi šlo především o rozhodnutí, zda komise vznikne ve stávajícím formátu (spolupráce s proděkanem) se Studentskou komorou požadovaným rozšířením transparence a míry závaznosti komise nebo bude pravomoc spravovat komisi předána studentům. Konečné rozhodnutí stavělo na *"nepřijatelnosti"* rozšíření požadovaných SK AS u komise spravované proděkanem. Člen vedení popisuje, že tento formát *"znejasňuje zodpovědnost, dělá z pedagogických členů komise experty na něco, v čem experty nejsou, systém je velmi náročný na posuzování a plné zveřejňování a případná diskuse o něm vystavuje pedagogické členy komise do nelehké situace. Proto jsme přijali argumentaci SK, že pravomoci navrhovat a být odpovědný za návrh by měl nést ten, kdo má k rozhodnutí nejblíže, který jsme uplatnili jak v tomto programu, tak i v dalších."*

Principu *přiblížení* rozhodovacího procesu příjemcům je věnována samostatná podkapitola. Při zvažování utvoření komise (ještě před konečným rozhodnutím) píše jeden ze senátorů, že *"je to práce navíc, ale zasadíme-li se o komisi, (…) můžeme systém decentralizovat a skrze komisi i přiblížit aktivním studentům"*. Při konečném rozhodnutí sehrál významnou roli jeden z aspektů rozhodování komise odpovědné proděkanovi, konkrétně neprůhlednosti celého procesu. Člen vedení fakulty zpětně popisuje, že coby *"[největší kritiku]"* vnímal, *"že se ty peníze rozdělují způsobem, který z našeho pohledu nebyl nespravedlivý, ale z vašeho pohledu byl nepředvídatelný. (…) To je přesně to, co člověka nejvíc irituje, když neví vlastně, jak to dopadne."*

### Ochota komunity a komise participovat

Uvnitř Studentské komory při přípravě procedury existovala *"obava z neaktivity komise"*. Konstruovaná procedura tak měla být téměř paternalistická: co nejlépe před-připravená a umožňovat co nejsnadnější *"protažení"* komisařů procesem. Jeden ze senátorů k tomu dodává, že je podstatné směřovat k *"efektivitě její práce (menší počet členů), k jednoduchosti hodnotících nástrojů (když už kategorie, tak 4 místo 16"*, jiný při obhajobě třífázového průběhu píše, že je *"určitě komplikovaný (byly i komplikovanější návrhy), je to ale daň za deliberativní prvek, který jsme tam chtěli mít."*

Výsledná práce s komisi však mnohem více odpovídala spolu-definování institucionálního mechanismu, jak o tom vypovídá text jednoho z jejích členů, krátce po jeho výběru do komise: *"[měli bychom] spolu s vámi být v úzké komunikaci a kontaktu, abychom případně tuto diskusi o smyslu stipendií mohli vstřebávat, anebo příp. i ovlivňovat."* a druhý dodává *"to jste si nasadili do komise šťouraly."* 

Nepotvrdil se ani předpoklad, že je celá procedura příliš časově náročná, přestože je tak i nyní zvenku vnímána (především vedením fakulty; více viz následující podkapitola *Smysl komise*). Pro současné členy komise časové vytížení *"není hrozné. Samozřejmě člověk ten čas tomu musí věnovat, protože má ten pocit zodpovědnosti, že rozděluje nějaký peníze."* Jiný z členů doplňuje: *"Hlavně, když jsem byl na té druhý straně (…) a žádal o peníze, tak vím, že jsem vždycky chtěl, aby o tom rozhodli co nejkvalitněji, ty lidi, tak jsem se tomu i sám snažil věnovat čas."* Více času prací pro komisi tráví především její předseda, který píše e-maily žadatelům, zadává žádosti do systému apod. 

Pro zvýšení motivace komisařů prosadila Studentská komora AS rozdílení dvou procent celkové rozdílené částky členům komise,^[Částka však nakonec nebyla rozdílena přímo ze zdrojů programu 6A.] kteří se však odměny buďto vzdali anebo ji berou spíše s pobavením: *"[navíc jsme] dostali od vedení 700 korun, takže se to vyplatí (smích)."*

Oproti očekávání tedy komisaři vnímali svou roli velmi aktivně, svou motivaci odvozovali jednak od snahy zapojit se do diskuse o *dobrých* studentských aktivitách --- do jisté míry z nespokojenosti s předchozím stavem rozdělování stipendií. Dva z nich popisují situaci velmi podobně, zde slova jednoho z nich: *"měl [jsem] pocit, (…) že ten systém není úplně pochopitelný, protože ta komise předtím fungovala asi dost ad hoc. [Asi] nikdo z těch, kdo o to stipendium žádali, jsem neměl pocit, že by věděl, (…) na základě jakých kritérií se to hodnotí"*.

Sami komisaři v mnoha ohledech pociťovali spíše nedostatečná omezení vlastních pravomocí a nedostatečnou znalost východisek, z nichž utvoření komise vzešlo. Částečně takto aktivní přístup vycházel i z organizačních problémů: *"na začátku nebylo moc jasný, jako jak se máme chovat (…) a navíc jsme na to neměli moc času,"* a též z nejasného vymezení vztahu mezi SK AS a komisí. Jeden z komisařů v problematickém období píše: *"Když změníme pravidla fungování, tak nám dají veto; systém hodnocení je také závislý na nich a komunikace momentálně taky, nemluvě o tom, že rozhodnutí komise o stipendiích zase bude předávat SK AS."* Na druhou stranu právě neujasněnost výchozí situace zpětně oceňují jako příležitost, kterou mohli využít: *"bylo dobře, že jsme jako ta první komise nebyli hozeni do nějakého mechanismu, který už automaticky funguje, ale byla tam právě ta diskuse"*. Další komisař popisuje, že jej *"bavil ten proces upravování do finální formy. Na začátku to bylo jako dobré, ale chtělo to ještě nějak dotáhnout a taková ta reflexe těch potíží, která se toho všeho týkala, tak to bylo hrozně zajímavé; bylo osvěžující potkávat se s názory ostatních členů komise"*.
...
Téma konvenční praxe komise se objevilo především v konstrukci termínů *porota* a *komise*, v nichž se setkalo mnoho rovin problému. Ze zpětného prozkoumání textů však vychází, že vztažení se k praxi *"[každé jiné] komise na [Fakultě sociálních studií] (disciplinární, státnicové, oborové, apod)"*, které vždy rozhodují kolektivně, "za zavřenými dveřmi", se omezilo na několik málo zmínek. Dále se s těmito pojmy pracovalo spíše v ostatních významových rovinách, které se týkaly především smyslu stipendia (viz níže kapitoly *Smysl stipendia* a *Předmět a povaha stipendia*).
...
První rovinou je přesunutí řešení problému na jiné aktéry --- především z důvodu předpokládané vyšší legitimity výsledného rozhodnutí. Klíčovou vlastností delegačního mechanismu je však následovné "vyklizení pole" prvním aktérem. Člen vedení fakulty vystihuje delegaci následovně: *"základní charakteristika toho procesu pro mě je ta, že jsem do značné míry s tím ztratil kontakt. Já vlastně přicházím do styku až s těmi závěrečnými výstupy. (…) Toho, kdo by o tom rozhodoval, [to zbavilo] docela nepříjemné povinnosti, jak si opatřovat informace o těch projektech (…) nebo jakým způsobem to vlastně dělat."* 

Tento proces souvisí jednak se stromově stavěnou strukturou manažerského řízení fakulty a zároveň též se vnímáním složení fakulty ze dvou do značné míry nezávislých entit, studentstva a akademických zaměstnanců. Členové vedení pak již považují rozhodování za ukotvené, *"nějak zvlášť [se nepídí] po tom, jak přesně jakou nastaveny vztahy mezi tou komorou a tou komisí"* a vlastní zásah považují za nutný pouze *"ve smyslu nějaké korekce, pokud by třeba vůči výsledkům nějakého toho kola byl nějaký masivní odpor…"* Jiný člen vedení dodává: *"ten další mechanismus (…) to už v podstatě mě netrápilo, protože já jsem to své stanovisko měl postavené tak, že mně je jedno, jak si to budete rozdělovat, vy si to budete muset zdůvodnit, my to v podstatě jenom schválíme."*

Delegace je vedením vnímána na obou úrovních --- na úrovni předání rozhodovací pravomoci Studentské komoře AS i na úrovni vytvoření komise Studentskou komorou. Pojímání pravomoci coby delegované je viditelné i v postojích členů komise. Ti říkají, že by přivítali zpětnou vazbu na činnosti komise, či alespoň otevřenou komunikaci (viz níže v podkapitole *Zpětnovazebné vztahy a pozice komise v kontextu instituce*).

Koncept *delegace* je možné vystihnout i negativně --- pokud je na konkrétní aktéry *přeneseno* rozhodování, je nelogické participovat na jejich činnosti. Jeden z později zvolených členů Studentské komory AS se např. ptá, zda je vhodné se účastnit jednání komise, či zda by to *"bylo proti smyslu jejího vytvoření"*. Velmi podobným způsobem popisuje důvody své neúčasti na diskusních setkáních jeden z členů vedení: *"Zapojit do té diskuse moc ne, protože vlastně o těch projektech jsem měl potom ještě rozhodovat, tzn. kdybych tam měl přijít, tak bych tam musel sedět a vlastně jenom poslouchat a to jsem se bál, že bych třeba úplně nedokázal omezit, že bych se do toho zapojil."* Překračování "kompetenčních úrovní" je tak vnímáno negativně, přestože daný aktér cítí, že by nejspíše měl v daném kontextu "co říct".

### Rozšíření participace na řešení problému

Druhým vymezitelným způsobem vnímání je rozšíření participace na širší pole aktérů --- především směrem ke studentům, ale s možností zahrnutí všech možných aktérů. Jednak jde o určitou formu *"samosprávy"* a zároveň jde o *"[nástroj pro kultivaci] prostředí"*. Role komise jako aktivujícího prvku, který umožňuje participaci širokého pole aktérů, byla ukotvena jednak v požadavku otevřenosti a jednak v praxi diskusních setkání přímo Studentskou komorou.

Prvním krokem je informovanost *veřejnosti* (*"i kdyby byl nějaký jiný způsob, který vybere dobré projekty, ale nebylo do něho pořádně vidět, tak je prostě horší, protože ti ostatní --- ti žadatelé a tak --- se v tom prostě nevyznají"*, citován jeden z komisařů) a *"zároveň to může plnit tu funkci, že ti studenti se tím pádem naučí chápat a vnímat, co to jsou ta stipendia atd."*, tedy jakási forma lokálně definované "občanské" vzdělanosti. 
...
> *"Jsme se bavili o tom, kolik by lidi měli dostávat lidi za hodinu (…), tak tam byly spory mezi komisaři a začali se tam hádat i před těmi lidmi a já se snažil těm lidem vysvětlit, že to není nic negativního, že od toho tam jsme, abychom se o tom takhle bavili, že ta komise je založená na tom, že ti lidi spolu nemusejí souhlasit a že tam jsou právě pro to, že mají nějaký určitý názor."*

Diskuse tak mohla "přetéct" mimo hranice komise a účastnili se jí i žadatelé z jiných projektů --- mohlo tak docházet ke kritičtější reflexi a zároveň k lepšímu pochopení společných problémů.

### Edukace komisařů

Sekundárním cílem, zdůrazňovaný členy vedení, je individuální edukace a osobní rozvoj komisařů. Role komise je pak *"stimulační"* pro ty, kteří mají příležitost v komisi *"coby lidé, kteří budou jednou dělat (…) důležitá rozhodnutí, úplně reálně třeba ovlivnit něco, co má dopady v té materiální oblasti"*. Zrcadlí se zde pojímání vysoké školy coby přípravného prostředí před nástupem do zaměstnání. Člen vedení doplňuje: *"už rozhodujete prostě o konkrétních osudech lidí, o konkrétních penězích, o konkrétních výstupech, už to není takové to jako jenom studentské ‚bude zábava, bude legrace‘ (smích)"*.
...
Posledním identifikovaným smyslem stipendia je podpora reprezentace fakulty. Spolková a kulturní činnost je *"věc, která vypadá pěkně i navenek (…) [uvádíme to] v různých materiálech pro uchazeče, že je tady třeba bohatá spolková činnost, což oni (…) ne úplně doceňují"*, říká člen vedení fakulty, který stipendium hodnotí jako *"dobře investované peníze. V tom rozsahu (…) to jsou peníze, které se fakultě vrátí"*. Stipendijní fond tak má z tohoto pohledu podobnou roli jako resort kultury na úrovni státu --- podporuje potenciální reprezentanty interní kultury (přirovnání použito respondentem).

## Předmět a povaha stipendia

Pravděpodobně nejvýznamnější hodnotový spor je vyjádřitelný opozicemi *záměr --- projekt* a s nimi související *vyplácení honoráře --- kompenzace nákladů*. S oběma jsme se již setkali výše, protože tento konflikt hodnotových východisek formoval do značné míry diskusi aktérů v prvním půlroce fungování komise.
...
Vedení školy se v tomto ohledu opět vrací k myšlence edukativního aspektu stipendií, tentokrát mířeno na žadatele, ti *"se učí tomu, jak to v reálném životě chodí: když podáváte grant, tak musíte zdůvodnit, musíte vysvětlit ty náklady. A když to dostanete, tak potom odvést nějakou tu práci, a ti ostatní se ptají, [jestli to stálo] za ty peníze."* Právě grantovou logiku ale někteří členové komise zpochybňují s ohledem na své kompetence (*"k tomu aby člověk mohl ohodnotit rozpočet, tak to vyžaduje nějakou zkušenost s těmi rozpočty a to si myslím, že jsme nikdo v té komisi neměli"*) a ji zároveň odůvodňují vlivem širšího kontextu na akademické prostředí: *"to možná souvisí skutečně s určitým pragmatismem, který na té univerzitě tak trošku je. Jsme zvyklí o ty peníze žádat jako o granty a vydělávat si a podobně, takže ten duch té univerzity je tak nahlodaný tady tou ekonomizací, s níž se asi nedá nic dělat jako radikálně, to prostě je logický důsledek nějakých složitějších společensko-ekonomických poměrů."* Opakovaná přirovnání stipendijní praxe k nějakému pozdějšímu procesu v zaměstnání, k *reálnému životu*, ze strany vedení fakulty i komisařů takovému pozorování nasvědčují.

Protilehlá poloha, vnímající předmět stipendia jako *záměr* (ať již realizovaný nebo teprve budoucí), chce přistupovat ke každé podané žádosti individuálním způsobem a klást vedle sebe její různé jedinečné vlastnosti. Komise je pak dle jednoho z komisařů *"politický orgán v uvozovkách. Máme rozhodovat na základě diskuse mezi sebou a mezi těmi, co podávali vlastně ty návrhy, o tom, co nám přijde jako dobré a co by se mělo podpořit a co ne"*. Pro takový způsob hodnocení jsou předem připravené kategorie, *"které jsou v uvozovkách objektivní"* a udělování bodů je *"mechanickým až technickým řešením té situace"*. Proto je takové pojetí stipendií v konfliktu s podobou hodnotící procedury.
...
Jak je vidět v druhé citaci, klíčová je zároveň časová strukturace. Oba způsoby mohou posilovat v nějaké míře oba ze "smyslů" diskusní "deliberativní" procedury --- a vhodná míra zastoupení obou elementů se může měnit v čase. V době, kdy existuje problém sdílený různými žadateli, je vhodné, aby se taková skutečnost projevila i v různých aspektech hodnotící procedury.
...
Zásadním problémem, vnímaným i vedením fakulty, byl možný střet zájmů, případně osobní vazby mezi studenty. Výsledkem by tak mohlo být rozdělování zdrojů "známým". Člen vedení k tomu říká: *"Když se podíváte na ta udělená stipendia, tak vidíte hodně členů senátu, tak běžte a vysvětlete to těm studentům, že to nejde vám, protože jste senátoři, ale protože ty projekty jsou dobré."* Obdobnou argumentací byly výsledky zpochybňovány vedením fakulty i v průběhu schvalování výsledků hodnocení vedením (kde byl autor tohoto textu přítomen).

Jeden z členů komise říká, že by *"dokázal obhájit, že to prostě není účelový pro senátory, ale na druhou stranu bych byl radši, kdyby nežádali…"*  Na druhou stranu vnímá původ problému v tom, *"že na [fakultě] je skupina asi třiceti lidí, kteří se podílí na všech těch projektech a do toho patří samozřejmě i senátoři. (…) Nedejbože občas dáváme peníze sami sobě, to je ještě horší"*. 

Řešením je v případech, kdy má komisař přímé spojení s konkrétním projektem, zdržení se hlasování. Praxe zdržování se nebyla zpočátku zřejmá, i kvůli nejasnosti v tom, jak by se podobný krok projevil v hodnocení. Studentská komora postavila praxi zdržování se na důvěře v osobní odpovědnost komisařů, podloženou veřejností celé procedury: *"Máte možnost se zdržet, povinnost nikoli. Hlasujte podle svého svědomí a, kdybyste nehlasovali, je tu pořád dostatečná základna pro hodnocení od ostatních."* Výhodou je úmyslné skládání komise z rozdílných osobností, snad i proto se zatím jeden ze členů komise, který působil v pozici jejího předsedy *"nesetkal s tím, že by za námi přišel někdo z těch jiných projektů a řekl nám, že někoho preferujeme"*.
...
Podoba zpětné vazby od vedení souvisí především s pojetím *delegace* určitého rozhodování na komisi. Vedení zaujímá spíše pozici vzdáleného příjemce agendy: *"já jsem k tomu vždycky psal nějaký dokument,"* popisuje jeden z členů komise, *"kde bylo jako shrnutí, co to je za projekty, a proč je podporujeme a tak, takže moje názory se asi dostaly k vedení, ale už ta cesta zpátky tam  nebyla. Myslím si, že pro mě by to bylo prospěšné, nějaký feedback. Ale fungovalo to i bez toho."*
...
3) *"Obecně mám pocit, že [univerzita] jako celek si úplně není jistá, aspoň to, co jsem mohl poznat já, co vlastně s těmi studentskými aktivitami a spolky má dělat."*

Autor považuje za zajímavý stupeň důvěry členů komise (vyjádřený v prvních dvou citacích) v to, že vedení je kompetentní k případnému komentování její činnosti. Nevnímají tedy distanci mezi studenty a vyučujícími jako nepřekonatelnou. Takový postoj je protikladný vůči stanovisku některých členů vedení i senátu, co se týče působení vyučujícího uvnitř samotné komise.
