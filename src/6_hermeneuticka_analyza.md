...
Užívané citace ze všech zdrojů jsou jazykově upraveny, v některých případech přeloženy do češtiny, pozice citovaných jsou označovány pouze velmi obecně vymezenou pozicí (člen vedení, člen komise atp.), jména užívaná v citacích jsou nahrazena dostatečně přesnou pozicí aktéra uvnitř fakulty (kde je možné obecnější označení, je ho využito) a je sjednocen užívaný gramatický rod. Všechny takové citace jsou uvedeny pro odlišení kurzívou. Drobné úpravy (především skloňování) jsou v citacích vyznačovány hranatými závorkami pozměněných pasáží; nejsou vypouštěna slova či měněny užívané termíny. Sebe-citace vyjádření autora jsou vždy explicitně označeny.

Název kapitoly "Pro a proti" odkazuje k bipolárnímu sporu --- tak tomu mnohdy nebylo. Jednak existuje velké množství rovin pojednávání institucionálního mechanismu, zároveň ne v každé z nich existovaly pouhé dva póly diskuse.
...
Uvnitř Studentské komory při přípravě procedury existovala *"obava z neaktivity komise"*. Konstruovaná procedura tak měla být téměř paternalistická: co nejlépe před-připravená a umožňovat co nejsnadnější *"protažení"* komisařů procesem. Jeden ze senátorů k tomu dodává, že je podstatné směřovat k *"efektivitě její práce (menší počet členů), k jednoduchosti hodnotících nástrojů (když už kategorie, tak 4 místo 16"*, jiný při obhajobě třífázového průběhu píše *"určitě je komplikovaný (byly i komplikovanější návrhy), je to ale daň za deliberativní prvek, který jsme tam chtěli mít"*.

Výsledná práce s komisi však mnohem více odpovídala spolu-definování institucionálního mechanismu, jak píše jeden z jejích členů: *"[měli bychom] spolu s vámi být v úzké komunikaci a kontaktu, abychom případně tuto diskusi o smyslu stipendií mohli vstřebávat, anebo příp. i ovlivňovat."* a druhý dodává *"to jste si nasadili do komise šťouraly :)"*. 

Nepotvrdil se ani předpoklad, že je celá procedura příliš časově náročná, přestože je tak i nyní zvenku vnímána (především vedením fakulty; více viz následující podkapitola *Smysl komise*). Ze současné perspektivy *"to není hrozné, samozřejmě člověk ten čas tomu musí věnovat, protože má ten pocit zodpovědnosti, že rozděluje nějaký peníze"*. Více času prací tráví jen její předseda, který píše e-maily žadatelům, zadává žádosti do systému apod. *"Hlavně, když jsem byl na té druhý straně (…) a žádal o peníze, tak vím, že jsem vždycky chtěl, aby o tom rozhodli co nejkvalitněji, ty lidi, tak jsem se tomu i sám snažil věnovat čas."*

Pro zvýšení motivace komisařů prosadila Studentská komora AS  rozdílení dvou procent celkové rozdílené částky členům komise, kteří se však buďto odměny vzdali anebo jej berou spíše s pobavením: *"[navíc jsme] dostali od vedení 700 korun, takže se to vyplatí (smích)"*.
...
Koncept *delegace* je možné vystihnout i negativně --- pokud je na konkrétní aktéry *přezeneseno* rozhodováno, je nelogické participovat na jejich činnosti. Jeden z později zvolených členů Studentské komory AS se např. ptá, zda je vhodné se účastnit jednání komise, či zda by to *"bylo proti smyslu jejího vytvoření"*. Velmi podobným způsobem popisuje důvody své neúčasti na diskusních setkáních jeden z členů vedení: *"Zapojit do té diskuse moc ne, protože vlastně o těch projektech jsem měl potom ještě rozhodovat, tzn. kdybych tam měl přijít, tak bych tam musel sedět a vlastně jenom poslouchat a to jsem se bál, že bych třeba úplně nedokázal omezit, že bych se do toho zapojil."* Překračování kompetenčních  úrovní je tak vnímáno negativně.
...
Vedení školy se v tomto ohledu opět vrací k myšlence edukativního aspektu stipendií, tentokrát mířeno na žadatele, ti *"se učí tomu, jak to v reálném životě chodí: když podáváte grant, tak musíte zdůvodnit, musíte vysvětlit ty náklady. A když to dostanete, tak potom odvést nějakou tu práci, a ti ostatní se ptají, [jestli to stálo] za ty peníze."* Právě grantovou logiku ale někteří členové komise zpochybňují s ohledem na své kompetence (*"k tomu aby člověk mohl ohodnotit rozpočet, tak to vyžaduje nějakou zkušenost s těmi rozpočty a to si myslím, že jsme nikdo v té komisi neměli"*) a zároveň odůvodňují vlivem širšího kontextu na akademické prostředí: *"to možná souvisí skutečně s určitým pragmatismem, který na té univerzitě tak trošku je. Jsme zvyklí o ty peníze žádat jako o granty a vydělávat si a podobně, takže ten duch té univerzity je tak nahlodaný tady tou ekonomizací, s níž se asi nedá nic dělat jako radikálně, to prostě je logický důsledek nějakých složitějších společensko-ekonomických poměrů, které já rozhodně měnit sám nechci."* Opakovaná přirovnání stipendijní praxe k nějakému pozdějšímu procesu v zaměstnání, k *reálnému životu*, ze strany vedení fakulty i komisařů takovému pozorování nasvědčují.

Protilehlá poloha, vnímající předmět stipendia jako *záměr* (ať již realizovaný nebo teprve budoucí), chce přistupovat ke každé podané žádosti individuálním způsobem a klást vedle sebe její různé jedinečné vlastnosti. Komise je pak dle jednoho z komisařů *"politický orgán v uvozovkách. Máme rozhodovat na základě diskuse mezi sebou a mezi těmi, co podávali vlastně ty návrhy, o tom, co nám přijde jako dobré a co by se mělo podpořit a co ne"*. Pro takový způsob hodnocení jsou předem připravené kategorie, *"které jsou v uvozovkách objektivní"*, a v nich udělované body *"mechanickým až technickým řešením té situace"*.
